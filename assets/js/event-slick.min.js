...
=======
    ...
    $(".logo-slide").slick({
        ...
        //nextArrow: "<div class='next'><svg class='lnr lnr-chevron-right'><use xlink:href='#lnr-chevron-right'></use></svg></div>",
        // prevArrow: "<div class='prev'><svg class='lnr lnr-chevron-left'><use xlink:href='#lnr-chevron-left'></use></svg></div>",
      nextArrow: "<div class='next'><<svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"> <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 5 7 7-7 7"/> </svg></div>",
        prevArrow: "<div class='prev'><svg class='lnr lnr-chevron-left'><use xlink:href='#lnr-chevron-left'></use></svg></div>",
        responsive: [{
            breakpoint: 1500,
            settings: {
...
>>>>>>> 294a7fd21c000afa5cc63a4dd7a9d100bbaa81c0
});
